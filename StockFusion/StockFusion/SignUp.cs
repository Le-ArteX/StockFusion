...
namespace StockFusion
{
    public partial class SignUp : Form
    {
        ...
        private void roundedButton1_Click(object? sender, EventArgs e)
        {
            ...
            if (result == DialogResult.Yes)
            {
                try
                {
                    ...
                    {
                        conn.Open();
                        string query = $"INSERT INTO [dbo].[{tableName}] ([FullName], [Email], [Phonenumber], [UserName], [Password], [UserType], [Status] ,[Answer]) VALUES (@FullName, @Email, @PhoneNumber, @UserName, @Password, @UserType, @Status ,@Answer)";
                        using (SqlCommand cmd = new SqlCommand(query, conn))
                        {
                            ...
                            cmd.Parameters.AddWithValue("@Answer", roundedTextBox8.Texts);
        ...
        private void roundedTextBox8_TextChanged(object sender, EventArgs e)
        {
